...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('#trustpilot-wrap')) {
    document.querySelector('#trustpilot-wrap').addEventListener('click', function () {
      ...
      setTimeout(function () {
        if (reviews) {
          var reviewsTop = document.querySelector('.product').getBoundingClientRect().top + window.scrollY + document.querySelector('.product').offsetHeight - document.querySelector('.header-bar').offsetHeight - document.querySelector('#reviews').offsetHeight;
          window.scrollTo({
            top: reviewsTop,
            left: 0,
            behavior: "smooth"
  ...
  var el = document.querySelector('#product-page');
  var mobOptions = document.querySelector('[data-moboptions]');
  var mobOptionsHeight = 0;

  // colour picker
  var toggleColours = document.querySelector('[data-togglecolours]');
  var colourPickerMobile = document.querySelector('#colour-picker-mobile');
  var colourPickerMobileHeight = 0;
  ...
  var mobOpNavBtns = document.querySelectorAll('#option-nav-mob > a');
  var opFieldsets = document.querySelectorAll('variant-radios fieldset');
  if (mobOpNavBtns.length && opFieldsets) {
    mobOpNavBtns.forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        ...
        var thisFs = document.querySelector(href);
        if (thisFs) {
  ...
  if (colourPickerMobile) {
    ...
    colourPickerMobile.querySelectorAll('button').forEach(function (btn) {
    ...
    if (toggleColours) {
      toggleColours.addEventListener('click', function (e) {
        ...
        if (colourPickerMobile) {
          var coloursTop = document.querySelector('.product__info-wrapper').getBoundingClientRect().top - document.querySelector('#colour-picker-mobile').offsetHeight + window.scrollY;
          var currentScroll = window.scrollY + document.querySelector('.header-bar').offsetHeight;
  ...
  var variantButtons = document.querySelectorAll('button.variant-button');
  ...
  var variantSwitcher = document.querySelector('variant-radios[data-section="{{ section.id }}"]') || document.querySelector('variant-selects[data-section="{{ section.id }}"]');
